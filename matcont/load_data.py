...
PO2_branch2_max_A_unstable = np.max(PO2_branch2["x"][2:-1:3], axis=0)[13:]
PO2_branch2_theta_stable = PO2_branch2["x"][-1][:13]
PO2_branch2_theta_unstable = PO2_branch2["x"][-1][13:]
...
ax.plot(
    PO4_branch1_theta_stable, PO4_branch1_max_A_stable, linestyle="solid", c="green"
)
...
ax.plot(
    PO5_branch1_theta_unstable, PO5_branch1_max_A_unstable, linestyle="dashed", c="blue"
)

ax.plot(PO5_branch1_theta_stable, PO5_branch1_max_A_stable, linestyle="solid", c="blue")
...
ax.plot(
    PO5_branch2_theta_unstable, PO5_branch2_max_A_unstable, linestyle="dashed", c="blue"
)

ax.plot(
    PO6_branch1_theta_unstable, PO6_branch1_max_A_unstable, linestyle="dashed", c="red"
)

ax.plot(PO6_branch1_theta_stable, PO6_branch1_max_A_stable, linestyle="solid", c="red")
...
ax.plot(
    PO6_branch2_theta_unstable, PO6_branch2_max_A_unstable, linestyle="dashed", c="red"
)
...
ax.scatter(
    [main_PO_branch_theta_unstable[0]],
